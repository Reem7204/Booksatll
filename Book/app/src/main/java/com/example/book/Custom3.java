...
public class Custom3 extends BaseAdapter{
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        TextView tv1=(TextView)gridView.findViewById(R.id.name2);
        TextView tv2=(TextView)gridView.findViewById(R.id.review);
        TextView tv3=(TextView)gridView.findViewById(R.id.date3);
