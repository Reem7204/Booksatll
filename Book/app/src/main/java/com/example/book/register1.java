...
public class register1 extends AppCompatActivity {
    ...
    Button b;
    String name, place, post, pin, phoneno, emailid, password, cpassword, url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e2 = (EditText) findViewById(R.id.place1);
        e3 = (EditText) findViewById(R.id.post1);
        e4 = (EditText) findViewById(R.id.pin1);
        e5 = (EditText) findViewById(R.id.emailid1);
        e6 = (EditText) findViewById(R.id.phoneno1);

        e8 = (EditText) findViewById(R.id.password1);
        e9 = (EditText) findViewById(R.id.cpassword1);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(password.equalsIgnoreCase(""))
                {
                    ...
                    RequestQueue queue = Volley.newRequestQueue(register1.this);
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("success")) {
                                    Toast.makeText(register1.this, "Successfully registered", Toast.LENGTH_SHORT).show();
                                }
                                    ...
                                    Toast.makeText(register1.this, "Unable to register", Toast.LENGTH_SHORT).show();
