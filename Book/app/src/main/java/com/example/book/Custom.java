...
public class Custom extends BaseAdapter{
    ...
    ArrayList<String> title,author,price,apimages;
    SharedPreferences sh;




    public Custom(Context applicationContext, ArrayList<String> title, ArrayList<String> author, ArrayList<String> price, ArrayList<String> apimages ) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        ImageView image=(ImageView)gridView.findViewById(R.id.imgbook);
        TextView tvtitle=(TextView)gridView.findViewById(R.id.title);
        TextView tvauthor=(TextView)gridView.findViewById(R.id.author);
        TextView tvprice=(TextView)gridView.findViewById(R.id.price);
