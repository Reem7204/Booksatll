...
public class custom5 extends BaseAdapter{
    ...
    ArrayList<String> title,author,price,quantity,date,d_date;
    SharedPreferences sh;




    public custom5(Context applicationContext, ArrayList<String> title, ArrayList<String> author, ArrayList<String> price, ArrayList<String> quantity, ArrayList<String> date, ArrayList<String> d_date) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        TextView tvdate2=(TextView)gridView.findViewById(R.id.date3);
        ...
        tvdate2.setText(d_date.get(position));
